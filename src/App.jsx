...
export default () => {
  ...
  return <div className="flex flex-1 overflow-hidden mx-5 flex-col-reverse sm:flex-row min-h-[calc(100vh-100px)]">
                ...
                { loaded && 
                    <div className="flex my-2">
                        <div ref={svgRef} className="rounded bg-sky-300 p-2 font-sans shadow-md shadow-white">
                            ...
                            <Graphviz className="hover:cursor-grab mx-auto" dot={diagram} options={{
                                zoom: true,
                            }} />
